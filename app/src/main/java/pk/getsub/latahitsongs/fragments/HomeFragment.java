package pk.getsub.latahitsongs.fragments;
...
import pk.getsub.latahitsongs.MainActivity;
import pk.getsub.latahitsongs.R;
import pk.getsub.latahitsongs.adapters.HomeCategoryAdapter;
import pk.getsub.latahitsongs.adapters.HomeCategoryOtherAdapter;
import pk.getsub.latahitsongs.adapters.HomeVideoAdapter;
...
import pk.getsub.latahitsongs.models.ItemModelCategory;
import pk.getsub.latahitsongs.models.ItemSlider;
import pk.getsub.latahitsongs.search.SearchListActivity;
import pk.getsub.latahitsongs.videoplay.YoutubePlay;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (JsonUtils.isNetworkAvailable(getActivity())) {
            new MyTaskSlider().execute(Config.SERVER_URL+ JsonConfig.SLIDER_URL);
            Log.e("urlslider",""+Config.SERVER_URL+JsonConfig.SLIDER_URL);
        } else {
